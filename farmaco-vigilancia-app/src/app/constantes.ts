...
export const quimioterapia = ['Noaduvante', 'Adyuvante', 'Paliativa'];

export const etnia = ['Ladino', 'Maya', 'Xinca', 'Garífuna']

export const zonaGeograficaGuatemala =
{ pais: "Guatemala",
                    departamentos: 
                    [    
                        {
    ...
    "items" : [
        ...
        },
        {
            ...
            "categorias": [
                ...
                {
                    "nombre": "Reacción similar con otro fármaco",
                    "puntuacion": 1,
                    "seleccionada": false
                }
            ]
